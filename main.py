...
if __name__ == '__main__':
    ...
    parser.add_argument('--train', default="data/CTB60bmes/train.bmes") 
    parser.add_argument('--dev', default="data/CTB60bmes/dev.bmes" )  
    parser.add_argument('--test', default="data/CTB60bmes/test.bmes") 
    ...
    gpu = torch.cuda.is_available()  #确定系统是否支持CUDA
    ...
    gaz_file = "data/zh.wiki.bpe.op200000.d50.w2v.txt"
