...
def train(data, save_model_dir, seg=True):
    ...
    for idx in range(data.HP_iteration):   #HP_iteration=50
        ...
        file_test=open('data/model_zx_dict/test.txt','a')
        if seg:
...
#修改训练集测试集验证集，修改模型保存地址，修改gpu
    ...
    savemodel ="data/model_zx_dict/saved_model.lstmcrf"
    ...
    model_dir = "data/model_zx_dict/saved_model.lstmcrf"
    dset_dir = "data/model_zx_dict/saved_model.lstmcrf.dset"
