...
#ZX
TRAIN_ZX='data/original_data/zx_data/train.zhuxian.wordpos'
DEV_ZX='data/original_data/zx_data/dev.zhuxian.wordpos'
TEST_ZX='data/original_data/zx_data/test.zhuxian.wordpos'
...
if __name__ == '__main__':
    ...
    preprocess(TRAIN_ZX,'zx_train_tmp')
    preprocess(DEV_ZX, 'zx_dev_tmp')
    preprocess(TEST_ZX, 'zx_test_tmp')

    #处理格式
    sentence_2_word('zx_train')
    sentence_2_word('zx_dev')
    sentence_2_word('zx_test')
